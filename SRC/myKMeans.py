...
def load_dataset():
    labelsMatrix = []
    thedata,columnNames = lf.load_data()
    ...
    yAxis = thedata[90000:,1]


    for index in range(1,len(thedata[0,:])):

        xAxis = thedata[90000:,index]
